...
- [Stable Diffusion WebUI Forge - Neo](https://github.com/Haoming02/sd-webui-forge-classic)からのSpectrum Integrated (sd_forge_spectrum)の流用をやめ、拡張機能の[sd-webui-forge-spectrum](https://github.com/hirorohi03/sd-webui-forge-spectrum)を追加しました。既にインストール済みのSpectrum Integratedは自動で削除されませんので、不要な場合はエクスプローラー等を使ってstable-diffusion-webui-reForge\extensions-builtin\sd_forge_spectrumをフォルダごと削除してください。
